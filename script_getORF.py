...
def long_ORF (all_frames):
	for gene_id in all_frames:
		...
		for frames in all_frames[gene_id]:
			...
			ORFs = re.finditer(r"(ATG[A-Z]*?(TAA|TGA|TAG))", all_frames[gene_id]["sequence"]) # Pesquisa todas as sequencias de DNA que começam com ATG e terminam com algum dos códons de parada. Armazena as correspondências em um objeto iterável
